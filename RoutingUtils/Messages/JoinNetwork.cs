...
namespace CoreDht
{
    ...
    /// In the context of this message, the Identity refers to the Joinee.
    /// </summary>
    public class JoinNetwork : NodeMessage, ICorrelatedMessage<Guid>
    {
        public Guid CorrelationId { get; }

        public JoinNetwork(NodeInfo identity, Guid correlationId) : base(identity)
        {
        ...
        public class Reply : NodeReply, ICorrelatedMessage<Guid>
        {
            ...
            public Reply(NodeInfo identity, Guid correlationId) : base(identity)
            {
                CorrelationId = correlationId;
            }
        }
